...
Смотря только на браузерный юзкейс можно было бы сразу брать токен через
куки, используя тапир, но не вижу смысла делать такое ограничение. 

Просмотр записи как операция полупользовательская ошибок не
